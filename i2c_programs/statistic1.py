...
# Function to calculate mean, minimum, and maximum values and save them into another table
def calculate_statistics():
    ...
    # Insert statistics data into another table
    query = "INSERT INTO other_sensor_reading1(sensorId,updateFrequency,meanValue, minimumValue, maximumValue) VALUES (?,5,?, ?, ?)"
    values = (format(sensor),temperature_stats[0], temperature_stats[1], temperature_stats[2])
    cursor.execute(query, values)
...
if __name__ == '__main__':
    # Start the data insertion every hour
    while True:
        insert_sensor_data()
