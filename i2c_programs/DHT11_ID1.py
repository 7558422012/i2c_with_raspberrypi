...
if humidity is not None and temperature is not None:
    ...
    cursor.execute("INSERT INTO other_sensor_reading(Id,sensorId,captureTime,updateFrequency,meanValue,minimumValue,maximumValue) VALUES (6,?,2,3,4,5,6)", (format(sensor),))
    conn.commit()
